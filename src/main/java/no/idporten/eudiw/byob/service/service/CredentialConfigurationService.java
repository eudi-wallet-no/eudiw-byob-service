...
public class CredentialConfigurationService {
    ...
    private Map<String, credentialConfiguration> persistenceLayer = new HashMap<>();
     ...
     */
    public Map<String, credentialConfiguration> getResponseModel(credentialConfiguration proof) {
    ...
    public String buildVct(credentialConfiguration proof) {
    ...
    public void updatePersistenceLayer(credentialConfiguration proof) {
