...
class CredentialConfigurationServiceTest {
    ...
    private static CredentialConfigurationRequestResource createCredentialConfigurationRequestResource(String credentialType) {
        ...
        return new CredentialConfigurationRequestResource(credentialType, "dc+sd-jwt", "eudiw:fop", null, new CredentialMetadataRequestResource(List.of(bevisName), List.of(new ClaimsRequestResource("path", null, null,true, List.of(claimName)))));
    }
